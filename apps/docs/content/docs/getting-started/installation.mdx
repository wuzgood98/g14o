...
Requires [`@g14o/paystack`](/packages/paystack) for the API client.

## Next steps

| Package | Guide |
|---------|-------|
| Cache | [Setup](/packages/cache/setup) |
| Rate limit | [Setup](/packages/ratelimit/setup) |
| Rate limit (Next.js) | [Setup](/packages/ratelimit-nextjs/setup) |
| Env | [Overview](/packages/env-core) |
| Paystack | [Client](/packages/paystack/client) |
| Paystack + Better Auth | [Server setup](/packages/paystack-better-auth/server) |
