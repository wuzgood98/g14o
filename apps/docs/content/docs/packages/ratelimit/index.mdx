...
- [Setup](/docs/packages/ratelimit/setup) — built-in tier defaults, custom tiers, build vs runtime
- [Route handlers & middleware](/docs/packages/ratelimit/middleware) — `withRateLimit`, per-user limits
- [API reference](/docs/packages/ratelimit/api) — types and `tokenConfigSnapshot`
...
For Express middleware and route handlers, use [@g14o/ratelimit-express](/docs/packages/ratelimit-express).
...
For Hono middleware and route handlers, use [@g14o/ratelimit-hono](/docs/packages/ratelimit-hono).
