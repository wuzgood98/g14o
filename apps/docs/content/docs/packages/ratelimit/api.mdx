...
Built-in limits are defined in core and exposed for inspection at runtime. Values always match the [default tiers table](/docs/packages/ratelimit/setup#default-tiers).
