...
- [Setup](/docs/packages/cache/setup) — TTL overrides and shared Redis client
- [Examples](/docs/packages/cache/examples) — `withCache`, invalidation, build vs runtime
- [API reference](/docs/packages/cache/api)
