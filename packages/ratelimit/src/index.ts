/**
 * Framework-agnostic rate limiting for `@g14o/ratelimit`.
 *
 * Prefer {@link createRateLimit} for app-owned instances (`lib/rate-limit.ts`).
 * Top-level exports are deprecated and rely on {@link configureUtils} from `@g14o/ratelimit/config`.
 *
...
/**
 * Higher-order function that rate-limits a request handler (deprecated).
 *
